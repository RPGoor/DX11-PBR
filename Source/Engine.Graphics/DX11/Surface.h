...
public:
    ...
    void PutPixel(unsigned int x, unsigned int y, Color c) conexcept;
    Color GetPixel(unsigned int x, unsigned int y) const conexcept;
    ...
    void Copy(const Surface& src) conexcept;
private:
