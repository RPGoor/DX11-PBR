...
{
    projection = DirectX::XMMatrixPerspectiveFovLH(DirectX::XMConvertToRadians(60.0f), 16.0f / 9.0f, 0.1f, 1000.0f);
...
void Camera::Translate(DirectX::XMFLOAT3 translation) noexcept
{
    ...
    pos = {pos.x + translation.x, pos.y + translation.y + (yComp * travelSpeed), pos.z + translation.z};
}
